...
const Home = () => {
  ...
  const handleQuestionClick = (question) => {
    ...
    axios
      .post("http://localhost:7186//API/Question", postData, {
        headers: {
  ...
  return (
    ...
    >
      <div
        className={`${theLang === "arabic" ? "flex-row-reverse" : ""
          } flex transition-all duration-200 h-[92.5vh] ${theme === "light" ? "bg-white" : "bg-black"
          }`}
      >
        <div
          dir={theLang === "arabic" ? "rtl" : ""}
          className={` ${!openSide ? "w-[0%]" : "w-[20%] h-[92.5vh]  px-1"
            }  flex relative flex-col gap-4 border-t-[2px]  transition-all duration-200 ${theme === "light"
              ? "bg-[#808080] border-t-white"
              : "bg-[#808080] border-t-black"
            }`}
        >
          <p
            className={`${!openSide && "hidden"} text-2xl p-2 font-semibold ${theme === "light" ? "text-white" : "text-black"
              } `}
          >
            {theLang === "english"
              ? "Last chats"
          ...
          <div
            className={`h-full flex items-center  absolute ${theLang === "arabic" ? "-left-6" : "-right-6"
              }`}
          >
            {theLang !== "arabic" && (
              <div>
          ...
          <div className="mx-auto flex gap-2 ltr w-[80%]">
            <div className="flex flex-col gap-2">
              <div
                ...
                className={`${!isHovered ? "w-[50px] px-2 py-1" : "w-[170px] p-2 gap-1"
              ...
              >
                ...
                <span
                  className={`${isHovered ? "flex" : "hidden"
              ...
              <div className="relative">
                <span
                  ...
                  className={`${!isHovered ? " px-2 py-1 " : "  px-2 py-1"
                ...
                {showLangs && (
                  <select
                    className={`${isHovered ? "left-[-57%]" : "left-[-200%]"} ${theme === "light"
              ...
              <div className="flex relative">
                ...
                {!theLoading ? (
                  <div
                    ...
                    className={`${theLang === "arabic" ? "left-2" : "right-2"
